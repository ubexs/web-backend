...
$(a).append("\n                    <a href=\"/ads\">\n                        <img style=\"width:160px;height:600px;\" src=\"https://cdn.blockshub.net/thumbnails/81082ace029ca2526b6a54e6f2d9914b2397a22c3d4e3260de402f872e093f97.png\" />\n                        <p class=\"ad-alert-text\"><i class=\"fas fa-ad\"></i></p>\n                    </a>\n            "),$(a).find("img").on("load",function(){console.log("ad image loaded"),$(a).find(".whitespace-ad").remove()})})});function getTheme(){if(!auth)return 0;var a=$("#userdata").attr("data-theme");return parseInt(a)}
